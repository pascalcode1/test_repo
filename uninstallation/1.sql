...
begin
    select util_module.get_module_param_val('test_repo', 'name1') into param_1 from dual;
    select util_module.get_module_param_val('test_repo', 'name2') into param_2 from dual;
    select util_module.get_module_param_val('test_repo', 'name3') into param_2 from dual;
